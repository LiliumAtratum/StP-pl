    ...
    viewport yadjustment yadj:
        ...
        vbox:
            for idx, i in enumerate(items):
                if idx == 0:
                    textbutton i.caption action i.action default_focus True keyboard_focus True
                        #hovered SetVariable("captured", renpy.focus_coordinates())
                else:
                    textbutton i.caption action i.action keyboard_focus True
                        #hovered SetVariable("captured", renpy.focus_coordinates())
                ...
                if loops_finished >= 1:
                    if first_mound == "adversary":
                        ...
                        if final_ending != "liberation":
                            ...
                            text "{size=30}False Idol{/size}" ypos song_ypos xpos 0
                ...
                if loops_finished >= 4:
                    if fourth_mound == "adversary":
                        ...
                        if final_ending != "liberation":
                            ...
                            text "{size=30}False Idol{/size}" ypos song_ypos xpos 150
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Quick Menu")
                    textbutton _("Visible") action [SetVariable("persistent.quick_menu", True), SetVariable("quick_menu", True)]
                    textbutton _("Hidden") action [SetVariable("persistent.quick_menu", False), SetVariable("quick_menu", False)]

                vbox:
                    style_prefix "radio"
                    label _("Blinking CTC")
                    textbutton _("On") action SetVariable("persistent.ctc", True)
                    textbutton _("Off") action SetVariable("persistent.ctc", False)
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("Boil Effect")
                    textbutton _("On") action SetVariable("persistent.performance_mode", False)
                    textbutton _("Off") action SetVariable("persistent.performance_mode", True)

                vbox:
                    style_prefix "radio"
                    label _("Parallax Effect")
                    textbutton _("On") action SetVariable("persistent.parallax_on", True)
                    textbutton _("Off") action SetVariable("persistent.parallax_on", False)
                ...
                vbox:
                    ...
                    textbutton _("On") action SetVariable("preferences.afm_enable", True)
                    textbutton _("Off") action SetVariable("preferences.afm_enable", False)
                ...
                vbox:
                    ...
                    textbutton _("Test") action Language("polish")
